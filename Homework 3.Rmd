...
qf(0.95, df1 = 1, df2 = 30)
```
The equation of the line is y=-0.015458x + 20.556354. A car with 300 horsepower based on our regression would have a quarter mile time of 15.02 seconds.

Based on the f-statistic of 30.19 being larger than the critical f-statistic of 4.17 we can reject the null hypothesis that the ratio is equal to one.
